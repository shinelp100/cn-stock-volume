...
获取中国 A 股四市（沪市/深市/创业板/北交所）指定日期的**成交金额**、增缩量及比例，并输出三市合计总结。**v1.2.0+ 新增三市涨跌家数统计**。
...
- 📈 **涨跌家数统计**（v1.2.0+）：三市上涨/下跌/平盘家数、涨跌比、市场情绪判断（强势/弱势/震荡）
...
### v1.2.2 (2026-03-21)
- 📈 **新增涨跌家数统计功能**：查询三市（沪市/深市/北交所）上涨/下跌/平盘家数
- 📊 **市场情绪判断**：根据涨跌比自动判断市场情绪（强势/偏强/震荡/偏弱/弱势）
- 📝 **JSON 输出增强**：advance_decline_summary 和 advance_decline_details 包含完整涨跌家数数据
